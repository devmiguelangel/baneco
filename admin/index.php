...
if(empty($_SESSION['usuario_sesion'])){
	...
	HeaderSlideshow();
	 ...
	 or ($lugar=="ap_parametros") or ($lugar=="ap_preguntas") or ($lugar=="ap_contenido") or ($lugar=="ap_ocupacion")
	 or ($lugar=="ap_planes") or ($lugar=="vi_parametros") or ($lugar=="vi_preguntas") or ($lugar=="vi_contenido")
	 or ($lugar=="vi_ocupacion") or ($lugar=="vi_planes")){
    HeaderTablas();
}
echo'<body>';
switch($lugar) {
		...
		case "modalidad":
			...
			break;
		case "ap_parametros":
		    include 'sgc_ap_parametros.php'; //ADMINISTRAR AP PARAMETROS
			break;
		case "ap_preguntas":
		    include 'sgc_ap_preguntas.php'; //ADMINISTRAR AP PREGUNTAS
			break;
		case "ap_contenido":
		    include 'sgc_ap_contenido.php'; //ADMINISTRAR AP CONTENIDO
			break;
		case "ap_ocupacion":
		    include 'sgc_ap_ocupacion.php'; //ADMINISTRAR AP OCUPACION
			break;
		case "ap_planes":
		    include 'sgc_ap_planes.php'; //ADMINISTRAR AP PLANES
			break;
		case "vi_parametros":
		    include 'sgc_vi_parametros.php'; //ADMINISTRAR VI PARAMETROS
			break;
		case "vi_preguntas":
		    include 'sgc_vi_preguntas.php'; //ADMINISTRAR VI PREGUNTAS
			break;
		case "vi_contenido":
		    include 'sgc_vi_contenido.php'; //ADMINISTRAR VI CONTENIDO
			break;
		case "vi_ocupacion":
		    include 'sgc_vi_ocupacion.php'; //ADMINISTRAR VI OCUPACION
			break;
		case "vi_planes":
		    include 'sgc_vi_planes.php'; //ADMINISTRAR VI PLANES
			break;																																					
		default:
