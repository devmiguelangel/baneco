				...
				<div class="da-panel-header" style="text-align:right; padding-top:5px; padding-bottom:5px;">
					<ul class="action_user">
						<li style="margin-right:6px;">
						   <a href="?l='.$_GET['l'].'&var='.$_GET['var'].'&crear=v&producto='.$_GET['producto'].'" class="da-tooltip-s various fancybox.ajax" title="Añadir Ocupacion">
										...
										while($regi = $res->fetch_array(MYSQLI_ASSOC)){
											echo'<tr>
													...
													<td class="da-icon-column">
													   <ul class="action_user">
														  <li style="margin-right:5px;"><a href="?l='.$_GET['l'].'&idocupacion='.base64_encode($regi['id_ocupacion']).'&id_ef='.base64_encode($regief['id_ef']).'&editar=v&var='.$_GET['var'].'&producto='.$_GET['producto'].'" class="edit da-tooltip-s" title="Editar"></a></li>
	...
	if($res1 = $conexion->query($select1,MYSQLI_STORE_RESULT)){
			 echo'<div class="da-panel collapsible">
					<div class="da-panel-header" style="text-align:right; padding-top:5px; padding-bottom:5px;">
						<ul class="action_user">
							<li style="margin-right:6px;">
							   <a href="?l='.$_GET['l'].'&var='.$_GET['var'].'&producto='.$_GET['producto'].'" class="da-tooltip-s" title="Volver">
