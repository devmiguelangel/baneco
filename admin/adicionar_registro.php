...
$(document).ready(function(e) {
		...
		$('#formCreaAdCia #idefin').change(function(){
			...
			if(idefin!=''){
				  $('#content-entidadf').fadeIn('slow');
				  var dataString = 'idefin='+idefin+'&opcion=buscar_producto_AdCia';
				   $.ajax({
						 async: true,
						 cache: false,
						 type: "POST",
						 ...
						 success: function(datareturn) {
							  if(datareturn!=''){
								 ...
								 $('#formCreaAdCia :submit').removeAttr('disabled');
							  }else{
								 $("#formCreaAdCia :submit").attr("disabled",true);
								 $('#entidad-loading').html('<div style="color:#d44d24; text-align:left;">Todos los productos de la Entidad Financiera ya fueron asignados a la Compañía de Seguros</div>'); 
							  }
						 }
				   });
			}else{
...
<?php	
	...
	echo'<div class="da-panel">
	 ...
	 echo'<div class="da-panel">
	  ...
	  //VERIFICAMOS QUE LAS ENTIDADES FINANCIERAS ESTEN ACTIVADAS O CREADAS
	  $select1="select
				  id_ef,
				  nombre,
				  codigo,
	 ...
	 //VERIFICAMOS QUE LAS COMPAÑIAS ESTEN ACTIVADAS O CREADAS
	 $select2="select
				  id_compania,
				  nombre
				from
		  ...
		  $('#frmAdPregunta').submit(function(e){
			  ...
			  if(sum==0){
					 ...
					 $.ajax({
						   ...
						   type: "POST",
						   url: "accion_registro.php",
						   data: FormCadena+'&opcion=crea_pregunta',
						   beforeSend: function(){
								$("#response-loading").css({
									'height': '30px'
								});
			...
			<div class="da-panel-content">
				<form class="da-form" name="frmAdPregunta" id="frmAdPregunta" action="" method="post">
						...
						<div class="da-form-item small">';
							   $select="select
										...
										from
										  s_sgc_home
										where
										  id_ef='".base64_decode($_GET['id_ef'])."' and producto!='H' and producto='".base64_decode($_GET['producto'])."';";
								$sql = $conexion->query($select,MYSQLI_STORE_RESULT);
								$reg = $sql->fetch_array(MYSQLI_ASSOC);
								echo $reg['producto_nombre'];
					 echo'</div>
					</div>
					<div class="da-form-row">
					...
					<div class="da-button-row">
						...
						<input type="hidden" id="txtProducto" name="txtProducto" value="'.$_GET['producto'].'"/>
						<div id="response-loading" class="loading-fac"></div>
					</div>
				</form>
			</div>
		  ...
		  $('#frmEdiPregunta').submit(function(e){
			  ...
			  if(sum==0){
					 ...
					 $.ajax({
						   ...
						   type: "POST",
						   url: "accion_registro.php",
						   data: FormCadena+'&opcion=edita_pregunta',
						   beforeSend: function(){
								$("#response-loading").css({
									'height': '30px'
								});
	...
	echo'<div class="da-panel">
			...
			<div class="da-panel-content">
				<form class="da-form" name="frmEdiPregunta" id="frmEdiPregunta" action="" method="post">
					...
					<div class="da-button-row">
						<input type="submit" value="Guardar" class="da-button green" name="btnPregunta" id="btnPregunta" lang="es"/>
						<input type="hidden" name="id_ef_cia" value="'.base64_decode($_GET['id_ef_cia']).'"/>
						<input type="hidden" name="id_pregunta" value="'.base64_decode($_GET['idpregunta']).'"/>
						<input type="hidden" name="txtProducto" value="'.$regi['producto'].'"/>
						<div id="response-loading" class="loading-fac"></div>
					</div>
				</form>
			</div>
    ...
    <script type="text/javascript">
       $(function(e) {
		  ...
		  $('#frmPlan').submit(function(e){
			  ...
			  var prima_mensual = $('#txtPrimaMes').prop('value');
			  var prima_anual = $('#txtPrimaAnual').prop('value');
			  var txtOp1 = $('#txtOp1').val();
			  var txtBs1 = $('#txtBs1').prop('value');
			  var txtOp2 = $('#txtOp2').val();
			  var txtBs2 = $('#txtBs2').prop('value');
			  var txtOp3 = $('#txtOp3').val();
			  var txtBs3 = $('#txtBs3').prop('value');
			  ...
			  $(this).find('.required').each(function() {
				   ...
				   if(descripcion!=''){
					   $('#errordescripcion').hide('slow');
				   }else{
					   sum++;
					   $('#errordescripcion').show('slow');
					   $('#errordescripcion').html('campo requerido');
				   }
				   if(prima_mensual!=''){
					   if(prima_mensual.match(/^[0-9\.]+$/)){
					       $('#errorprima_mes').hide('slow');
					   }else{
						   sum++;
					       $('#errorprima_mes').show('slow');
					       $('#errorprima_mes').html('ingrese solo numeros');
					   }
				   }else{
					   sum++;
					   $('#errorprima_mes').show('slow');
					   $('#errorprima_mes').html('campo requerido');
				   }
				   if(prima_anual!=''){
					   if(prima_anual.match(/^[0-9\.]+$/)){
					       $('#errorprima_anual').hide('slow');
					   }else{
						   sum++;
					       $('#errorprima_anual').show('slow');
					       $('#errorprima_anual').html('ingrese solo numeros');
					   }
				   }else{
					   sum++;
					   $('#errorprima_anual').show('slow');
					   $('#errorprima_anual').html('campo requerido');
				   }
				   if(txtOp1!=''){
					  $('#error_op1').hide('slow');  
				   }else{
					  sum++;
					  $('#error_op1').show('slow');
					  $('#error_op1').html('campor requerido');   
				   }
				   if(txtBs1!=''){
					   if(txtBs1.match(/^[0-9\.]+$/)){
					     $('#error_bs1').hide('slow');
						 ...
						 sum++;
					     $('#error_bs1').show('slow');
					     $('#error_bs1').html('ingrese solo numeros');   
					   }
				   }else{
					  sum++;
					  $('#error_bs1').show('slow');
					  $('#error_bs1').html('campo requerido'); 
				   }
				   if(txtOp2!=''){
					  $('#error_op2').hide('slow');  
				   }else{
					  sum++;
					  $('#error_op2').show('slow');
					  $('#error_op2').html('campo requerido');   
				   }
				   if(txtBs2!=''){
					   if(txtBs2.match(/^[0-9\.]+$/)){
					     $('#error_bs2').hide('slow');
						 ...
						 sum++;
					     $('#error_bs2').show('slow');
					     $('#error_bs2').html('ingrese solo numeros');   
					   }
				   }else{
					  sum++;
					  $('#error_bs2').show('slow');
					  $('#error_bs2').html('campo requerido'); 
				   }
				   if(txtOp3!=''){
					  $('#error_op3').hide('slow');  
				   }else{
					  sum++;
					  $('#error_op3').show('slow');
					  $('#error_op3').html('campor requerido');   
				   }
				   if(txtBs3!=''){
					   if(txtBs3.match(/^[0-9\.]+$/)){
					     $('#error_bs3').hide('slow');
						 ...
						 sum++;
					     $('#error_bs3').show('slow');
					     $('#error_bs3').html('ingrese solo numeros');   
					   }
				   }else{
					  sum++;
					  $('#error_bs3').show('slow');
					  $('#error_bs3').html('campo requerido'); 
				   }
			  });
			  if(sum==0){
					 $("#frmPlan :submit").attr("disabled", true);
					 e.preventDefault();
					 var FormCadena = $(this).serialize();
					 //alert (FormCadena);
					 //ejecutando ajax
					 $.ajax({
						   ...
						   type: "POST",
						   url: "accion_registro.php",
						   data: FormCadena+'&opcion=crea_plan',
						   beforeSend: function(){
								$("#response-loading").css({
									'height': '30px'
								});
						   ...
						   success: function(datareturn) {
								  ...
								  if(datareturn==1){
									 ...
									 $('#response-loading').html("Hubo un error al crear el registro");
									 e.preventDefault();
								  }
...
<?php	
	$select="select
			...
			where  
			  ssh.id_ef='".base64_decode($_GET['id_ef'])."' and ssh.producto='".base64_decode($_GET['producto'])."';";
	$res = $conexion->query($select,MYSQLI_STORE_RESULT);
	$regi = $res->fetch_array(MYSQLI_ASSOC);
	echo'<div class="da-panel">
		   <div class="da-panel-header">
				<span class="da-panel-title">
					<img src="images/icons/black/16/pencil.png" alt="" />
					<span lang="es">Crear Registro Plan</span>
				</span>
			</div>
			<div class="da-panel-content">
				<form class="da-form" name="frmPlan" action="" method="post" id="frmPlan">
					<div class="da-form-row">
						 <label style="text-align:right;"><b><span lang="es">Entidad Financiera</span></b></label>
						 <div class="da-form-item small">
							 '.$regi['entidad_financiera'].'
						 </div>	 
					</div>
					<div class="da-form-row" id="content-entidadf">
						<label style="text-align:right;"><b><span lang="es">Producto</span></b></label>
						<div class="da-form-item small">
						   '.$regi['producto_nombre'].'
						</div>
					</div>
					<div class="da-form-row">
						<label style="text-align:right;"><b><span lang="es">Nombre</span></b></label>
						<div class="da-form-item large">
							<input class="required textbox" type="text" name="txtNombre" id="txtNombre" value="" autocomplete="off"/>
							<span class="errorMessage" id="errornombre"></span>
						</div>
					</div>
					<div class="da-form-row" style="padding:0px 0px 0px 3px;">
						<label style="text-align:right;"><b><span lang="es">Descripción</span></b></label><br/><br/>
						<div style="text-align:center;">
							<textarea id="txtDescripcion" name="txtDescripcion" style="height:70px;" class="required"></textarea>
							<span class="errorMessage" id="errordescripcion"></span>
						</div>
					</div>
					<div class="da-form-row">
						<label style="text-align:right;"><b><span lang="es">Prima Mensual (Bs.)</span></b></label>
						<div class="da-form-item small">
							<input class="required textbox" type="text" name="txtPrimaMes" id="txtPrimaMes" value="" autocomoplete="off"/>
							<span class="errorMessage" id="errorprima_mes"></span>
						</div>
					</div>
					<div class="da-form-row">
						<label style="text-align:right;"><b><span lang="es">Prima Anual (Bs.)</span></b></label>
						<div class="da-form-item small">
							<input class="required textbox" type="text" name="txtPrimaAnual" id="txtPrimaAnual" value="" autocomoplete="off"/>
							<span class="errorMessage" id="errorprima_anual"></span>
						</div>
					</div>
					<div class="da-form-row">
						<label style="text-align:right;"><b><span lang="es">Rango Planes</span></b></label><br/>
						
						  <table border="0" cellspacing="0" cellpadding="0">
						     <tr>
							   <td valign="top">
							     <textarea class="required" name="txtOp1" id="txtOp1" style="height:50px; width:270px;"></textarea>
								 <span class="errorMessage" id="error_op1"></span>
						       </td>
							   <td style="padding-left:3px;" valign="bottom">
							     <input class="required" type="text" name="txtBs1" id="txtBs1" value="" autocomoplete="off" style="width:150px; text-align:right;"/> Bs.
								 <span class="errorMessage" id="error_bs1"></span>
							   </td>
							 </tr>
							 <tr>
							   <td valign="top">
							     <textarea class="required" name="txtOp2" id="txtOp2" style="height:50px; width:270px;"></textarea>
								 <span class="errorMessage" id="error_op2"></span>
						       </td>
							   <td style="padding-left:3px;" valign="bottom">
							     <input class="required" type="text" name="txtBs2" id="txtBs2" value="" autocomoplete="off" style="width:150px; text-align:right;"/> Bs.
								 <span class="errorMessage" id="error_bs2"></span>
							   </td>
							 </tr>
							 <tr>
							   <td valign="top">
							     <textarea class="required" name="txtOp3" id="txtOp3" style="height:50px; width:270px;"></textarea>
								 <span class="errorMessage" id="error_op3"></span>
						       </td>
							   <td style="padding-left:3px;" valign="bottom">
							     <input class="required" type="text" name="txtBs3" id="txtBs3" value="" autocomoplete="off" style="width:150px; text-align:right;"/> Bs.
								 <span class="errorMessage" id="error_bs3"></span>
							   </td>
							 </tr>
						  </table>
					...
					<div class="da-button-row">
					   ...
					   <div id="response-loading" class="loading-fac"></div>
					   <input type="hidden" name="id_ef" value="'.$_GET['id_ef'].'"/>
					   <input type="hidden" name="txtProducto" value="'.$_GET['producto'].'"/>
					</div>
				</form>
			</div>
		 </div>';
}elseif($_GET['opcion']=='editar_plan'){
?>
   <script type="text/javascript">
    tinymce.init({
        selector: "textarea#txtDescripcion",
   ...
   <script type="text/javascript">
      $(function(e) {
		  ...
		  $('#frmPlan').submit(function(e){
			  var nombre = $('#txtNombre').prop('value');
			  var descripcion = $('#txtDescripcion').val();
			  var prima_mes = $('#txtPrimaMes').prop('value');
			  var prima_anual = $('#txtPrimaAnual').prop('value');
			  var txtOp1 = $('#txtOp1').val();
			  var txtBs1 = $('#txtBs1').prop('value');
			  var txtOp2 = $('#txtOp2').val();
			  ...
			  if(sum==0){
					 ...
					 $.ajax({
						   ...
						   type: "POST",
						   url: "accion_registro.php",
						   data: FormCadena+'&opcion=edita_plan',
						   beforeSend: function(){
								$("#response-loading").css({
									'height': '30px'
								});
...
<?php	
	$query="select
			...
			from
			  s_plan
			where
			  id_plan=".base64_decode($_GET['id_plan'])." and id_ef='".base64_decode($_GET['id_ef'])."' and producto='".base64_decode($_GET['producto'])."';";
	$result = $conexion->query($query, MYSQLI_STORE_RESULT);
	$rowPl = $result->fetch_array(MYSQLI_ASSOC);
	$plan = json_decode($rowPl['plan'], true);
	$queryEf="select
			   ssh.id_ef,
			   ssh.producto,
			   ssh.producto_nombre,
			...
			where  
			  ssh.id_ef='".base64_decode($_GET['id_ef'])."' and ssh.producto='".base64_decode($_GET['producto'])."';";
	$resultEf = $conexion->query($queryEf, MYSQLI_STORE_RESULT);
	$rowEf = $resultEf->fetch_array(MYSQLI_ASSOC);		  
	echo'<div class="da-panel">
		   <div class="da-panel-header">
				<span class="da-panel-title">
					<img src="images/icons/black/16/pencil.png" alt="" />
					<span lang="es">Editar Registro Plan</span>
				</span>
			</div>
			<div class="da-panel-content">
				<form class="da-form" name="frmPlan" action="" method="post" id="frmPlan">
					<div class="da-form-row">
						 <label style="text-align:right;"><b><span lang="es">Entidad Financiera</span></b></label>
						 <div class="da-form-item small">
							 '.$rowEf['entidad_financiera'].'
						 </div>	 
					</div>
					<div class="da-form-row" id="content-entidadf">
						<label style="text-align:right;"><b><span lang="es">Producto</span></b></label>
						<div class="da-form-item small">
						   '.$rowEf['producto_nombre'].'
						</div>
					</div>
					<div class="da-form-row">
						<label style="text-align:right;"><b><span lang="es">Nombre</span></b></label>
						<div class="da-form-item large">
							<input class="required textbox" type="text" name="txtNombre" id="txtNombre" value="'.$rowPl['nombre'].'" autocomoplete="off"/>
							<span class="errorMessage" id="errornombre"></span>
						</div>
					</div>
					<div class="da-form-row" style="padding:0px 0px 0px 3px;">
						<label style="text-align:right;"><b><span lang="es">Descripción</span></b></label><br/><br/>
						<div style="text-align:center;">
							<textarea id="txtDescripcion" name="txtDescripcion" style="height:70px;" class="required">'.$rowPl['descripcion'].'</textarea>
							<span class="errorMessage" id="errordescripcion"></span>
						</div>
					</div>
					<div class="da-form-row">
						<label style="text-align:right;"><b><span lang="es">Prima Mensual (Bs.)</span></b></label>
						<div class="da-form-item large">
							<input class="required textbox" type="text" name="txtPrimaMes" id="txtPrimaMes" value="'.$rowPl['prima_mensual'].'" autocomoplete="off"/>
							<span class="errorMessage" id="errorprima_mes"></span>
						</div>
					</div>		
					<div class="da-form-row">
						<label style="text-align:right;"><b><span lang="es">Prima Anual (Bs.)</span></b></label>
						<div class="da-form-item large">
							<input class="required textbox" type="text" name="txtPrimaAnual" id="txtPrimaAnual" value="'.$rowPl['prima_anual'].'" autocomoplete="off"/>
							<span class="errorMessage" id="errorprima_anual"></span>
						</div>
					</div>
					<div class="da-form-row">
						<label style="text-align:right;"><b><span lang="es">Rango Planes</span></b></label><br/>
						  ...
						  <table border="0" cellspacing="0" cellpadding="0">
						     <tr>
							   <td valign="top">
							     <textarea class="required" name="txtOp1" id="txtOp1" style="height:50px; width:270px;">'.$plan[0]['cov'].'</textarea>
								 <span class="errorMessage" id="error_op1"></span>
						       </td>
							   <td style="padding-left:3px;" valign="bottom">
							     <input class="required" type="text" name="txtBs1" id="txtBs1" value="'.$plan[0]['rank'].'" autocomoplete="off" style="width:150px; text-align:right;"/> Bs.
								 <span class="errorMessage" id="error_bs1"></span>
							   </td>
							 </tr>
							 <tr>
							   <td valign="top">
							     <textarea class="required" name="txtOp2" id="txtOp2" style="height:50px; width:270px;">'.$plan[1]['cov'].'</textarea>
								 <span class="errorMessage" id="error_op2"></span>
						       </td>
							   <td style="padding-left:3px;" valign="bottom">
							     <input class="required" type="text" name="txtBs2" id="txtBs2" value="'.$plan[1]['rank'].'" autocomoplete="off" style="width:150px; text-align:right;"/> Bs.
								 <span class="errorMessage" id="error_bs2"></span>
							   </td>
							 </tr>
							 <tr>
							   <td valign="top">
							     <textarea class="required" name="txtOp3" id="txtOp3" style="height:50px; width:270px;">'.$plan[2]['cov'].'</textarea>
								 <span class="errorMessage" id="error_op3"></span>
						       </td>
							   <td style="padding-left:3px;" valign="bottom">
							     <input class="required" type="text" name="txtBs3" id="txtBs3" value="'.$plan[2]['rank'].'" autocomoplete="off" style="width:150px; text-align:right;"/> Bs.
								 <span class="errorMessage" id="error_bs3"></span>
							   </td>
							 </tr>
						  </table>
					...
					<div class="da-button-row">
					   ...
					   <input type="hidden" name="id_ef" value="'.$_GET['id_ef'].'"/>
					   <input type="hidden" name="txtProducto" value="'.$_GET['producto'].'"/>
					   <input type="hidden" name="id_plan" value="'.$rowPl['id_plan'].'"/>
					</div>
				</form>
			</div>
		 </div>';		  
