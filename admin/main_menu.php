...
function main_navegation($link_page,$id_usuario_sesion,$tipo_sesion,$usuario_sesion,$conexion){
		...
		if($tipo_sesion!='ROOT'){
			  ...
			  $listado = array("cabecera", "entidadfin", "inicio", "creausuario", "formularios", "compania", "desgravamen", "poliza", "facultativode", "admindatos", "certificadomedico", "email", "agencia", "agregaciaef", "sucursal", "automotores", "formapago", "estados", "todoriesgod", "triesgoeqmov", "tipocambio", "tarjetahabiente", "modalidad", "accidentespersonales", "vidaindividual");
			  foreach($listado as $acceso){
					switch($acceso) {
						...
						case 'tarjetahabiente': //TRAJETAHABIENTE
						    $tarjetahabiente = true;
						    break;
						case 'accidentespersonales': //PRODUCTO ACCIDENTES PERSONALES
						    $accidentespersonales = true;
							break;
						case 'vidaindividual': //PRODUCTO VIDA INDIVIDUAL
						    $vidaindividual = true;
							break;																 	
					}
			  }
			...
			echo'<ul>';
			   ...
			   if($accidentespersonales){    //ACCIDENTES PERSONALES
				   if($link_page=='ap_preguntas' or 
				      $link_page=='ap_parametros' or 
					  $link_page=='ap_contenido' or 
					  $link_page=='ap_ocupacion' or
					  $link_page=='ap_planes'){
						$data='class="active"'; $close='';
				   }else{$data=''; $close='class="closed"';}
				   echo'<li '.$data.'>
							<a href="#">
								...
								<div lang="es">Accidentes Personales</div>
							</a>
							<ul '.$close.'>
								<li><a href="?l=ap_parametros&var=ap&producto='.base64_encode('AP').'" lang="es">Administrar parametros del Producto</a></li>
								
								<li><a href="?l=ap_preguntas&var=ap&list_compania=v&producto='.base64_encode('AP').'" lang="es">Administrar preguntas</a></li>
							    <li><a href="?l=ap_contenido&var=ap&producto='.base64_encode('AP').'" lang="es">Administrar contenido</a></li>
								
								
								<li><a href="?l=ap_ocupacion&var=ap&producto='.base64_encode('AP').'" lang="es">Administrar Ocupación</a></li>
								<li><a href="?l=ap_planes&var=ap&producto='.base64_encode('AP').'" lang="es">Administrar Planes</a></li>
								
							</ul>
						</li>';
			   }
			   if($vidaindividual){    //VIDA INDIVIDUAL
				   if($link_page=='vi_preguntas' or 
				      $link_page=='vi_parametros' or 
					  $link_page=='vi_contenido' or 
					  $link_page=='vi_ocupacion' or
					  $link_page=='vi_planes'){
						$data='class="active"'; $close='';
				   }else{$data=''; $close='class="closed"';}
				   echo'<li '.$data.'>
							<a href="#">
								...
								<div lang="es">Vida Individual</div>
							</a>
							<ul '.$close.'>
								<li><a href="?l=vi_parametros&var=vi&producto='.base64_encode('VI').'" lang="es">Administrar parametros del Producto</a></li>
								
								<li><a href="?l=vi_preguntas&var=vi&list_compania=v&producto='.base64_encode('VI').'" lang="es">Administrar preguntas</a></li>
							    <li><a href="?l=vi_contenido&var=vi&producto='.base64_encode('VI').'" lang="es">Administrar contenido</a></li>
								
								
								<li><a href="?l=vi_ocupacion&var=vi&producto='.base64_encode('VI').'" lang="es">Administrar Ocupación</a></li>
								<li><a href="?l=vi_planes&var=vi&producto='.base64_encode('VI').'" lang="es">Administrar Planes</a></li>
