...
?>
    ...
    $reporting.hide();
        ...
        var rep = {
            ...
            xAxis: {
                //enabled: false;
                categories: ['Accidentes Personales - Vida Individual']
            },
            yAxis: {
                title: {
                    text: 'Nro. Polizas'
                        ...
                        events: {
                            click: function () {
                                ...
                                $.fancybox({
                                    ...
                                    'transitionOut': 'fade',
                                    'type': 'iframe',
                                    'href': 'get-data-report-ap-vi.php?' + data_det
                                });
                            ...
                            data_det = data_det + '&frp-agency=' + agency ;
                                ...
                                $.get("get-data-graph.php?gr-flag=4", data_det, function(ap) {
                                    $.get("get-data-graph.php?gr-flag=5", data_det, function(vi) {
                                        $reporting.fadeIn();
                                        $reporting.html('Nro. Accidentes Personales: ' + ap + ' - Nro. Vida Individual ' + vi);
                                    });
                                });
                            },
                            mouseOut: function () {
...
//alert(json);
               ...
               $.get("get-data-graph.php?gr-flag=2", data, function(ap) {
                    ...
                    rep.xAxis.categories = ['Accidentes Personales ' + ap + ' - Vida Individual ' + vi]
