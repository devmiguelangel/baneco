...
class CertificateSibas extends CertificateQuery{
		...
		if ($this->error === FALSE) {
			if ($this->implant === true) {
				...
				case 'TH':
					...
					break;
				case 'AP':
					$this->title = 'Poliza-Accidentes-Personales';
					break;
				case 'VI':
					$this->title = 'Poliza-Vida-Individual';
					break;
				}
				...
				if ($this->category === 'SC') {
					...
					case 'DE':
						...
						break;
					case 'AU':
						$this->subject = 'Slip de Cotizacion Automotores No. ' 
							. $this->rowPo['no_cotizacion'];
						break;
					case 'TRD':
						$this->subject = 'Slip de cotizacion Todo Riesgo Domiciliario No. ' 
							. $this->rowPo['no_cotizacion'];
						break;
					case 'TRM':
						$this->subject = 'Slip de Cotizacion Todo Riesgo Equipo Movil No. ' 
							. $this->rowPo['no_cotizacion'];
						break;
					case 'AP':
						$this->subject = 'Slip de Cotizacion Accidentes Personales No. ' 
							. $this->rowPo['no_cotizacion'];
						break;
					case 'VI':
						$this->subject = 'Slip de Cotizacion Vida Individual No. ' 
							. $this->rowPo['no_cotizacion'];
						break;
					}
					...
					case 'DE':
						...
						break;
					case 'AU':
						$this->subject = 'Certificado Automotores Poliza No. ' 
							. $this->rowPo['no_emision'];
						break;
					case 'TRD':
						$this->subject = 'Certificado Todo Riesgo Domiciliario Poliza No. ' 
							. $this->rowPo['no_emision'];
						break;
					case 'TRM':
						$this->subject = 'Certificado Todo Riesgo Equipo Movil Poliza No. ' 
							. $this->rowPo['no_emision'];
						break;
					case 'TH':
						...
						break;
					case 'AP':
						$this->subject = 'Poliza Accidentes Personales No. ' 
							. $this->rowPo['no_poliza'];
						break;
					case 'VI':
						$this->subject = 'Poliza Vida Individual No. ' 
							. $this->rowPo['no_poliza'];
						break;
					}
		...
		try
		{
		    if ($this->category === 'SC') {
				...
				case 'TRM':
					...
					break;
				case 'AP':
					$this->namePdf = 'slip_cotizacion_AP.pdf';
					break;
				case 'VI':
					$this->namePdf = 'slip_cotizacion_VI.pdf';
					break;
				}
			} elseif ($this->category === 'CE'){
				switch ($this->product) {
				...
				case 'TRM':
					...
					break;
				case 'AP':
					$this->namePdf = 'poliza_emision_AP.pdf';
					break;
				case 'VI':
					$this->namePdf = 'poliza_emision_VI.pdf';
					break;
				}
			} elseif($this->category === 'CP'){
				switch ($this->product) {
	...
	private function _MAIL() {
		...
		$mail->Host = 'baneco@sudseguros.com';
		$mail->From = 'baneco@sudseguros.com';
		$mail->FromName = $this->rowPo['ef_nombre'];
