...
if($token === TRUE){
	...
	case md5('MS_TH'):
		...
		break;
	case md5('MS_AP'):		//MENU ACCIDENTES PERSONALES
		switch($page){
		case md5('P_issue'):	//EMISION DE COTIZACIONES
			$product = 'AP';
			require('issue-price.inc.php');
		...
		case md5('P_provisional'):	//CERTIFICADO PROVISIONAL
			...
			break;
		default:
			echo '<meta http-equiv="refresh" content="0;url=ap-quote.php" >';
			break;
		}
		break;
	case md5('MS_VI'):		//MENU VIDA INDIVIDUAL
		switch($page){
		case md5('P_issue'):	//EMISION DE COTIZACIONES
			$product = 'VI';
			require('issue-price.inc.php');
		...
		case md5('P_provisional'):	//CERTIFICADO PROVISIONAL
			...
			break;
		default:
			echo '<meta http-equiv="refresh" content="0;url=vi-quote.php" >';
			break;
		}
		break;
	...
	if ($ms !== NULL) {
		...
		case md5('MS_TH'):
			...
			break;
		case md5('MS_AP'):		//MENU TODO RIESGO DOMICILIARIO
			switch($page){
			case md5('P_quote'):
				$seguro = 'AP';
				require('content-quote.inc.php');
			...
			break;
		case md5('MS_VI'):		//MENU TODO RIESGO DOMICILIARIO
			switch($page){
			case md5('P_quote'):
				$seguro = 'VI';
				require('content-quote.inc.php');
