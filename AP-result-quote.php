<h3>Seguro de Accidentes Personales - Tenemos las siguientes ofertas</h3>
...
<div class="result-quote" style="height:300px;">
	...
	<a href="certificate-detail.php?idc=<?=
		...
		base64_encode('AP');?>&type=<?=base64_encode('PRINT');?>" 
...
?>
	<a href="ap-quote.php?ms=<?=$_GET['ms'];?>&page=<?=$_GET['page'];?>&pr=<?=
		base64_encode('AP|05');?>&idc=<?=$_GET['idc'];?>&flag=<?=
...
?>
	<div style="border: 1px solid #fc9797; background: #fff2f2; 
		...
		Su solicitud no puede ser procesada debido a la(s) enfermedad(es) del 
		cuestionario de salud. Si desea mayor información porfavor envíe su 
