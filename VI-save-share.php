...
if (isset($_GET['idc'])
	...
	$sql = 'update s_vi_cot_cabecera as sdc
		inner join 
	...
	if ($link->query($sql) === true) {
		$arrDE[0] = 1;
		echo '<meta http-equiv="Refresh" content="0;url=vi-quote.php?ms=' 
			. $ms.'&page=' . $page . '&pr=' . base64_encode('VI|05')
			.'&idc=' . base64_encode($idc) . '&flag=' . md5('i-new') . '&cia=' 
			. base64_encode($idCia) . '">';
		if ($link->affected_rows > 0) {
			/*$arrDE[1] = 'vi-quote.php?ms='.$ms.'&page='.$page.'&pr='.base64_encode('VI|05')
