...
where
						...
						sca.fecha_anulado between '".$date_ini."' and '".$date_fin."'
ORDER BY
sca.no_emision ASC"; 				
//echo $selectdes;
...
$shtml="<table border='0' cellspacing='1' cellpadding='0' style='width:150%; font-size:9pt;'>";
			$shtml.='<tr><td colspan="23" align="center">REPORTE DE ANULADOS '.month($m).' '.$y.'</td></tr>';
...
$sfile=$scarpeta."/Reporte de Anulados ".month($m)." ".$y.".xls"; //ruta del archivo a generar
$fp=fopen($sfile,"w");
