...
?>
                ...
                <h5>Anulado</h5>
                <div>
                	<label class="lbl-cb"><input type="radio" id="frp-canceled-si" 
                		name="frp-canceled-p" value="1">&nbsp;SI</label>
					<label class="lbl-cb"><input type="radio" id="frp-canceled-no" 
						name="frp-canceled-p" value="0" checked>&nbsp;NO</label>
		            <label class="lbl-cb"><input type="radio" id="frp-canceled-both" 
		            	name="frp-canceled-p" value="">&nbsp;Todos</label>
