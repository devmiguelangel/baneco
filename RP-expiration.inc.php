...
<h3 class="h3">Reportes de Vencimiento de Pólizas</h3>
<?php
$class = $display = '';
...
?>
		<td style="width:40%; border-bottom:1px solid #CECECE;">
        	<input type="hidden" id="flag" name="flag" value="<?=md5('RE');?>">
		</td>
	</tr>
</table>
<?php
...
?>
            ...
            <label style="">Días de Vencimiento: </label>
            <select id="frp-expiration" name="frp-expiration" style="width: auto;">
				<option value="">Seleccione...</option>
<?php foreach ($link->days_expiration as $key => $value): ?>
