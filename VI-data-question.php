...
<h3>Seguro de Vida Individual - Cuestionario</h3>
<?php
...
<?php
			while($rowCl = $rsCl->fetch_array(MYSQLI_ASSOC)){
				...
				echo '<h4>Titular '.$cont.' - '.$rowCl['titular'].'</h4><br>
...
?>
	...
	<input type="hidden" id="pr" name="pr" value="<?=base64_encode('VI|03');?>">
