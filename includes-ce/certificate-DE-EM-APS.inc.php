        ...
        <br>
         ...
         <div style="width: 775px; text-align: left; font-size: 80%; font-weight: bold;">
          ...
          <div style="width: 775px; border: 0px solid #FFFF00; font-size: 85%;">
            ...
            <table border="0" cellpadding="0" cellspacing="0" style="width: 100%; height: auto; font-weight: bold; font-family: Arial; font-size:100%;">
              <tr>
                ...
                <td style="width: 50%;">
                    <table border="0" cellpadding="0" cellspacing="0" style="width: 100%; height: auto; font-size: 100%;
                        ...
                        <tr>
                            <td style="width: 50%; font-weight: normal; border: 1px solid #000; border-right: 0 none; border-bottom: 0 none; text-align: center">Invalidez Total y Permanente</td>
                            <td style="width: 50%; font-weight: normal; border: 1px solid #000; border-left: 0 none; border-bottom: 0 none; text-align: center;">B</td>
                        </tr>
                        <tr>
