...
require('AP-reports-general.class.php');
require('VI-reports-general.class.php');
...
if(isset($_GET['data-pr']) && isset($_GET['flag'])){
	...
	switch(base64_decode($pr)){
		...
		case 'TRM':
			...
			break;
		case 'AP':
			$rptrm = new ReportsGeneralAP($arrData, $pr, $flag, $xls);
			...
			break;
		case 'VI':
			$rptrm = new ReportsGeneralVI($arrData, $pr, $flag, $xls);
