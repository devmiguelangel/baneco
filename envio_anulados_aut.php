...
where
						...
						sca.motivo_anulado like '%Sobrepasa los 90 %' and
						sca.fecha_anulado between '2015-01-12' and curdate()
ORDER BY
sca.no_emision ASC"; 				
//echo $selectdes;
...
$shtml="<table border='0' cellspacing='1' cellpadding='0' style='width:150%; font-size:9pt;'>";
			$shtml.='<tr><td colspan="23" align="center">REPORTE DE ANULADOS POR MORA</td></tr>';
			...
			$shtml.='<tr style="background:#D3DCE3;">
					  ...
					  <td align="center"><b>Fecha Anulado</b></td>
					  <td align="center"><b>Motivo Anulado</b></td>
					  <td align="center"><b>Anulado Por</b></td>
					 </tr>';
				while($rap = $cap->fetch_array(MYSQL_ASSOC)){
					$capital = json_decode($rap['plan'], true);
						 ...
						 $shtml.='<tr>
							  ...
							  <td align="center">'.$rap['fecha_anulado'].'</td>
							  <td align="center">'.$rap['motivo_anulado'].'</td>
							  <td align="center">'.$rap['anulador'].'</td>
						</tr>';
				}
				...
				while($rvi = $cvi->fetch_array(MYSQL_ASSOC)){
					$capital = json_decode($rvi['plan'], true);
						 ...
						 $shtml.='<tr>
							  ...
							  <td align="center">'.$rvi['fecha_anulado'].'</td>
							  <td align="center">'.$rvi['motivo_anulado'].'</td>
							  <td align="center">'.$rvi['anulador'].'</td>
						</tr>';
				}		
			$shtml.="</table>";
...
$sfile=$scarpeta."/Reporte de Anulados Automaticos.xls"; //ruta del archivo a generar
$fp=fopen($sfile,"w");
